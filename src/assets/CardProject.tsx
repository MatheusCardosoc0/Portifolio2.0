  ...
  return (
    <motion.div className='bg-gray-300  rounded-lg overflow-hidden mb-12 mx-12'>
      ...
      style={{
        ...
        <BsEyeFill className='relative left-0 top-0 z-10 group-hover:left-1/2 group-hover:top-1/2 group-hover:-translate-x-1/2 group-hover:-translate-y-1/2 transition-all text-2xl text-gray-300 group-hover:text-5xl' />
      </div>
    </motion.div>
  )
}
